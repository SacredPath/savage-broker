-- Direct fix for tier_upgrade_rpc function conflict
-- This will drop the specific existing function and create the correct one

-- Drop the existing function with specific signature
DROP FUNCTION IF EXISTS public.tier_upgrade_rpc(uuid, boolean);

-- Now create the correct function
CREATE OR REPLACE FUNCTION public.tier_upgrade_rpc(
