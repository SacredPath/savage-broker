-- Fix investment_tiers table - Drop and recreate with proper structure
-- This script ensures the table has all required columns

-- Drop existing table if it exists
DROP TABLE IF EXISTS public.investment_tiers CASCADE;

-- Recreate investment_tiers table with correct structure
...
SELECT 'investment_tiers table created successfully' as status;
