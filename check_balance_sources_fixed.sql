-- CORRECTED Query to show the actual balance table structure
-- This will verify what columns actually exist in the tables
...
-- 2. Show sample data from wallet_balances table (using only existing columns)
SELECT 
